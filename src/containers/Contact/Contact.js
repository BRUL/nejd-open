    ...
    return (
      <div className="Contact">
        <address>
          ...
          <p><a itemProp="email"  href="mailto:info@nejd.be" className="important">info@nejd.be</a><br />
            <a itemProp="telephone" href="tel:+32495647823" className="">+32 495 647823</a></p>
          <p className="social">
